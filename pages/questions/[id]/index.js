...
export default function QuestionDetail({params: id}){
  return (
    <Layout>
        ...
        <div className="w-4/5 bg-white rounded-lg flex flex-col items-center space-y-5 py-12 px-6 z-10 shadow-2xl">
          ...
          <div className="space-y-4 mx-10">
            <div className="flex flex-col mt-4 border-b border-gray-300">
              ...
              <img src="https://johnstillk8.scusd.edu/sites/main/files/imagecache/carousel/main-images/camera_lense_0.jpeg" alt="" className="w-[40%] h-[40%] pt-4" />
              <div className="flex justify-between items-center my-4">
                <div className="flex flex-col items-start justify-end w-full md:flex-row md:items-center text-gray-400">
                  <div className="flex items-center md:space-x-2">
                    <img src="https://source.unsplash.com/75x75/?portrait" alt="" className="w-5 h-5 border rounded-full dark:bg-gray-500 dark:border-gray-700" />
